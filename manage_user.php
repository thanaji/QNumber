              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="Edituser.php?userid=<?php echo $rowuser["UserID"];?>" class ="btn btn-primary">edit</a> | <a href="delete_user.php?userid=<?php echo $rowuser["UserID"];?>" class ="btn btn-danger" onclick="return confirm('คุณต้องการที่จะลบข้อมูลนี้หรือไม่?');">delete</a> 
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
